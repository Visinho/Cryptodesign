...
// Instantiation and passing `true` enables exceptions
    ...
    $mail->Host       = 'Coinfranchise.com';  // Specify main and backup SMTP servers
    $mail->SMTPAuth   = true;                                   // Enable SMTP authentication
    $mail->Username   = $from;                     // SMTP username
    $mail->Password   = 'cit@2020?';                               // SMTP password
...
if (isset($_POST['send']) && $_POST['send'] == 1) {
    $subject = "New message from ".$_POST['name']." with email ".$_POST['email'];
    sendMail('support@Coinfranchise.com',$subject,'admin@Coinfranchise.com',$_POST['message']);
}
